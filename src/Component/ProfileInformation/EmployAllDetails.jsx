...
function EmployAllDetails() {
    ...
    const [Responce2, SetResponce2] = useState({});
...
// Responce1.PaymentDetailsID.map((data) =><h1 className='text-3xl text-green-600 ' key={data._id}><span className='text-black'>Sallary </span>: {data.Salary}</h1>)


/**            <h1 className=' ml-6 '><span className=' text-bold text-green-900'>Name</span> : {Responce1.Name} </h1>
                    <h1 className=' ml-6 '><span className=' text-bold text-green-900'>Email</span> :{Responce1.Email}  </h1>
                    <h1 className=' ml-6 '><span className=' text-bold text-green-900'>Phone Number </span>:{Responce1.PhoneNumber}  </h1>
                    <h1 className=' ml-6 '><span className=' text-bold text-green-900'>Address </span> :{Responce1.Address}  </h1>
                    <h1 className=' ml-6 '><span className=' text-bold text-green-900'>Sallary</span> : {Responce1.Sallary} </h1> */